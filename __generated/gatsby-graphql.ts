...
export type LayoutQuery = { site?: { siteMetadata?: { title?: string | null, description?: string | null, siteUrl?: string | null } | null } | null };

export type BlogPageQueryVariables = Exact<{ [key: string]: never; }>;


export type BlogPageQuery = { allFile: { nodes: Array<{ name: string }> } };
